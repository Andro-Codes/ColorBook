...
public class ColorWheelPalette extends View {
    ...
    protected void onSizeChanged(int i, int i2, int i3, int i4) {
        ...
        if (min >= 0.0f) {
            ...
            this.huePaint.setShader(new SweepGradient(this.centerX, this.centerY, new int[]{0xffff0000, -65281, -16776961, -16711681, -16711936, InputDeviceCompat.SOURCE_ANY, 0xffff0000}, (float[]) null));
