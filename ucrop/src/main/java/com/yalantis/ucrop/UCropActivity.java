...
public class UCropActivity extends AppCompatActivity {
    ...
    private void setupViews(@NonNull Intent intent) {
        ...
        mActiveControlsWidgetColor = intent.getIntExtra(UCrop.Options.EXTRA_UCROP_COLOR_CONTROLS_WIDGET_ACTIVE, ContextCompat.getColor(this, R.color.ucrop_color_blaze_orange));
